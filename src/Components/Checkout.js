...
import imagep from '../Images/payment-method.png'
								...
								<div className="row">
									...
									<div className="col-lg-6 col-md-6 col-12">
										<div className="form-group">
											...
											<select name="country_name" id="country" className="nice-select">
									...
									<div className="col-lg-6 col-md-6 col-12">
										<div className="form-group">
											...
											<select name="state-province" id="state-province" className="nice-select">  
